...
# blood samples
blood_ped_be <- lmer(ped_be ~ age*pearls + pearls + age + sex + income_FPL_100 + (1 | pearls_id),
...
# buccal samples
buccal_ped_be <- lmer(ped_be ~ age*pearls + pearls + age + sex + income_FPL_100 + (1 | pearls_id),
